        ...
        <section className="py-20 bg-gray-50">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/pic2.avif" alt="Rose" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/pic1.avif" alt="tulip" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]" >
                            <Image src="/pic3.png" alt="lily" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/daisies.jpg" alt="daisies" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/orchids.avif" alt="orchids" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12">
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/hydrangea.png" alt="hydrangea" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/daffodils.webp" alt="daffodils" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-12">
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/jasmine.avif" alt="jasmine" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/lavendar.jpg" alt="lavendar" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-[300px] h-[300px] md:w-[350px] md:h-[350px]">
                            <Image src="/marigold.jpg" alt="marigold" width={350} height={350} className="rounded-lg shadow-lg object-cover w-full h-full transition-transform duration-300 hover:scale-105 hover:shadow-2xl" /></div>
